...
- 首次引导使用的稳定 Launcher：`0.5.1`
- 本文发布后签名通道安装的 Workflow：`0.5.1`
- Converter：`1.2.2`
- Knowledge Runtime：`0.1.3`
- Agent protocol：`6`
...
```text
https://raw.githubusercontent.com/VisualLogic-VLCode/ivx-v4-v5-migration/v0.5.1/docs/AI-AGENT-BOOTSTRAP.md
```
