...
- 首次引导使用的稳定 Launcher：`0.6.0`
- 本文发布后签名通道安装的 Workflow：`0.6.0`
- Converter：`1.2.2`
- Knowledge Runtime：`0.1.4`
- Agent protocol：`7`
...
```text
https://raw.githubusercontent.com/VisualLogic-VLCode/ivx-v4-v5-migration/v0.6.0/docs/AI-AGENT-BOOTSTRAP.md
```
