...
- 首次引导使用的稳定 Launcher：`0.6.2`
- 本文发布后签名通道安装的 Workflow：`0.6.2`
- Converter：`1.2.2`
...
```text
https://raw.githubusercontent.com/VisualLogic-VLCode/ivx-v4-v5-migration/v0.6.2/docs/AI-AGENT-BOOTSTRAP.md
```
