...
- 首次引导使用的稳定 Launcher：`0.5.0`
- 本文发布后签名通道安装的 Workflow：`0.5.0`
- Converter：`1.2.2`
...
```text
https://raw.githubusercontent.com/VisualLogic-VLCode/ivx-v4-v5-migration/v0.5.0/docs/AI-AGENT-BOOTSTRAP.md
```
