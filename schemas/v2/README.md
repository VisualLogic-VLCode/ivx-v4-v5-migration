...
- Native results are linked `agent-native-observation-bundle` artifacts. They record actual revisions/origins/environment/effects and `OBSERVED_EQUIVALENT`, `OBSERVED_MISMATCH`, or `INCONCLUSIVE` without strict-parity claims. Removed runtime-test kinds are rejected as unsupported rather than loaded, migrated, or reinterpreted.
